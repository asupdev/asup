...
import org.asup.dk.parser.antlr.AsupLexer;
import org.asup.dk.parser.antlr.AsupParser;



public class Parser_asup extends Parser {
	...
	public Iterator<Token> tokenize(String expression) throws InvalidExpressionException {
        ...
        AsupLexer lexer = new AsupLexer(input);
        AsupParser parser = new AsupParser(new CommonTokenStream(lexer));
