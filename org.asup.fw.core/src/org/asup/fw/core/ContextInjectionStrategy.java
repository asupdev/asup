...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Context Injection Strategy</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.asup.fw.core.QFrameworkCorePackage#getContextInjectionStrategy()
 * @model
 * @generated
 */
public enum ContextInjectionStrategy implements Enumerator {
	 ...
	 * @generated
	 */
	private static final ContextInjectionStrategy[] VALUES_ARRAY =
		new ContextInjectionStrategy[] {
			LOCAL,
			REMOTE,
		};

	/**
	 * A public read-only list of all the '<em><b>Context Injection Strategy</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
