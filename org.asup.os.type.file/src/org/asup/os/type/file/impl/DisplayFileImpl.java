...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>QDisplay File</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class DisplayFileImpl extends FileImpl implements QDisplayFile {
	 ...
	 * @ordered
	 */
	protected EList<QDisplayFormatDef> displayFormats;
	 ...
	 * @generated
	 */
	public List<QDisplayFormatDef> getDisplayFormats() {
		if (displayFormats == null) {
			displayFormats = new EObjectContainmentEList<QDisplayFormatDef>(QDisplayFormatDef.class, this, QOperatingSystemFilePackage.DISPLAY_FILE__DISPLAY_FORMATS);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case QOperatingSystemFilePackage.DISPLAY_FILE__DISPLAY_FORMATS:
				...
				getDisplayFormats().addAll((Collection<? extends QDisplayFormatDef>)newValue);
				return;
		}
