 ...
 * <ul>
 *   <li>{@link org.asup.os.type.file.impl.PrinterFileFormatImpl#getFields <em>Fields</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PrinterFileFormatImpl extends FileFormatImpl<QPrinterFileField> implements QPrinterFileFormat {
	 ...
	 * @ordered
	 */
	protected EList<QPrinterFileField> fields;
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case QOperatingSystemFilePackage.PRINTER_FILE_FORMAT__FIELDS:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case QOperatingSystemFilePackage.PRINTER_FILE_FORMAT__FIELDS:
				getFields().clear();
				getFields().addAll((Collection<? extends QPrinterFileField>)newValue);
				return;
		}
