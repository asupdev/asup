...
public class MessageDescriptionChanger {
	...
	public @Entry void main(
			...
			@DataDef(dimension = 20, length = 32) QArray<QEnum<ValidReplyValue, QCharacter>> validReplyValues,
			@DataDef(dimension = 20) QStroller<SpecialReplyValue> specialReplyValues,
			...
			@DataDef(dimension = 102) QArray<QEnum<DataToBeDumped, QBinary>> dataToBeDumped,
