...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>QSystem Status</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.asup.os.core.OSCorePackage#getQSystemStatus()
 * @model
 * @generated
 */
public enum QSystemStatus implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>QSystem Status</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final QSystemStatus[] VALUES_ARRAY =
		new QSystemStatus[] {
			ACTIVATING,
			STARTED,
			ENDING,
	...
	/**
	 * A public read-only list of all the '<em><b>QSystem Status</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<QSystemStatus> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>QSystem Status</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static QSystemStatus get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			QSystemStatus result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>QSystem Status</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static QSystemStatus getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			QSystemStatus result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>QSystem Status</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static QSystemStatus get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private QSystemStatus(int value, String name, String literal) {
		this.value = value;
		this.name = name;
