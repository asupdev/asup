 ...
 * @generated
 */
public class DatetimeFactoryImpl extends EFactoryImpl implements QDatetimeFactory {
	/**
	 ...
	 * @generated
	 */
	public static QDatetimeFactory init() {
		try {
			QDatetimeFactory theDatetimeFactory = (QDatetimeFactory)EPackage.Registry.INSTANCE.getEFactory(QDatetimePackage.eNS_URI);
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case QDatetimePackage.DATE_FORMAT:
				return createDateFormatFromString(eDataType, initialValue);
			case QDatetimePackage.TIME_FORMAT:
	 ...
	 * @generated
	 */
	public QDatetimePackage getDatetimePackage() {
		return (QDatetimePackage)getEPackage();
	}
	 ...
	 */
	@Deprecated
	public static QDatetimePackage getPackage() {
		return QDatetimePackage.eINSTANCE;
	}
