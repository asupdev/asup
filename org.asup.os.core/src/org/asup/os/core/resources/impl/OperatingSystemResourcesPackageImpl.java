...
public class OperatingSystemResourcesPackageImpl extends EPackageImpl implements QOperatingSystemResourcesPackage {
	 ...
	 * @see org.asup.os.core.resources.QOperatingSystemResourcesPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		resourceFactoryEClass.getESuperTypes().add(this.getResourceProvider());
		resourceProviderEClass.getESuperTypes().add(theFrameworkCorePackage.getService());
		...
		g1 = createEGenericType(theOperatingSystemCorePackage.getLockable());
		...
		initEClass(resourceFactoryEClass, QResourceFactory.class, "ResourceFactory", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		op = addEOperation(resourceFactoryEClass, null, "registerListener", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = addEOperation(resourceFactoryEClass, null, "registerProvider", 0, 1, IS_UNIQUE, IS_ORDERED);
