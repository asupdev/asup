...
public class OperatingSystemResourcesFactoryImpl extends EFactoryImpl implements QOperatingSystemResourcesFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case QOperatingSystemResourcesPackage.RESOURCE_SET_READER: return (EObject)createResourceSetReader();
			default:
	 ...
	 * @generated
	 */
	public <T extends QObjectNameable> QResourceSetReader<T> createResourceSetReader() {
		ResourceSetReaderImpl<T> resourceSetReader = new ResourceSetReaderImpl<T>();
