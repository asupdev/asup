...
public class E4ObjectIteratorCompoundImpl<T extends QObjectNameable> implements QObjectIterator<T>{
	...
	public E4ObjectIteratorCompoundImpl(Stack<QResourceReader<T>> readers, String namePrefix, QResourceEvent<T> resourceEvent) {
