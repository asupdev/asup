 ...
 * <ul>
 *   <li>{@link org.asup.db.core.impl.SchemaDefImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SchemaDefImpl extends DatabaseObjectDefImpl implements QSchemaDef {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QDatabaseCorePackage.SCHEMA_DEF__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QDatabaseCorePackage.SCHEMA_DEF__NAME:
				return getName();
		}
