...
public class IndexColumnImpl extends MinimalEObjectImpl.Container implements QIndexColumn {
	...
	protected EClass eStaticClass() {
		return QIntegratedLanguageIsamPackage.Literals.INDEX_COLUMN;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QIntegratedLanguageIsamPackage.INDEX_COLUMN__NAME, oldName, name));
	}
	...
	public void setDescend(boolean newDescend) {
		...
		descend = newDescend;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QIntegratedLanguageIsamPackage.INDEX_COLUMN__DESCEND, oldDescend, descend));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QIntegratedLanguageIsamPackage.INDEX_COLUMN__NAME:
				return getName();
