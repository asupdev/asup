...
public class BaseFifoQueueManager {
	...
	public void createQueue(String aLib, String aName)
			throws BaseFifoQueueException {

		String vQueueKey = buildQueueKey(aLib, aName);
		if (iQueueList.containsKey(vQueueKey) == false) {
			BaseBlockingFifoQueue<String> vNewQueue = new BaseBlockingFifoQueue<String>(
					aLib, aName);
			iQueueList.put(vQueueKey, vNewQueue);
		} else {
			throw new BaseFifoQueueException(
					BaseFifoQueueException.QUEUE_ALREADY_EXISTS);
		}

	}

	public void removeQueue(String aLib, String aName)
			throws BaseFifoQueueException {
		String vQueueKey = buildQueueKey(aLib, aName);
		if (iQueueList.containsKey(vQueueKey)) {
			...
			throw new BaseFifoQueueException(
					BaseFifoQueueException.QUEUE_DO_NOT_EXISTS);
		}

	}

	public void writeToQueue(String aLib, String aName, String aValue)
			throws BaseFifoQueueException {
		String vQueueKey = buildQueueKey(aLib, aName);
		if (iQueueList.containsKey(vQueueKey)) {

			BaseBlockingFifoQueue<String> vFifoQueue = iQueueList
					.get(vQueueKey);
	...
	public String readFromQueue(String aLib, String aName, long aTimeout)
			throws BaseFifoQueueException {
		String vResult = null;
	...
	public String peekFromQueue(String aLib, String aName, long aTimeout)
			throws BaseFifoQueueException {
	...
	public void clearQueue(String aLib, String aName)
			throws BaseFifoQueueException {
		String vQueueKey = buildQueueKey(aLib, aName);
		if (iQueueList.containsKey(vQueueKey)) {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("Lettura: "
					+ vQueueManager.readFromQueue("testlib", "testqueue", -1));
			System.out
					.println("Lettura: "
							+ vQueueManager.readFromQueue("testlib",
									"testqueue", 3000));
