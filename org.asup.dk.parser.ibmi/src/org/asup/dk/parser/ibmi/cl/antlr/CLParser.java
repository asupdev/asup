...
public class CLParser extends Parser {
	...
	// $ANTLR start "parse"
	// CL.g:93:1: parse : ( row | ( ( WS )* CR ) )* EOF -> ^( CL[$parse.text] ( row )* ) ;
	public final CLParser.parse_return parse() throws RecognitionException {
		...
		try {
			// CL.g:93:8: ( ( row | ( ( WS )* CR ) )* EOF -> ^( CL[$parse.text] ( row )* ) )
			// CL.g:94:3: ( row | ( ( WS )* CR ) )* EOF
			{
			// CL.g:94:3: ( row | ( ( WS )* CR ) )*
			loop2:
			while (true) {
	...
	// $ANTLR start "row"
	// CL.g:97:1: row : ( single_label | command_row );
	public final CLParser.row_return row() throws RecognitionException {
		...
		try {
			// CL.g:97:5: ( single_label | command_row )
			int alt3=2;
			alt3 = dfa3.predict(input);
			switch (alt3) {
				case 1 :
					// CL.g:98:5: single_label
					{
					root_0 = (CommonTree)adaptor.nil();
	...
	// CL.g:102:1: single_label : label ( WS )* CR -> ^( ROW[$single_label.text] label ) ;
	public final CLParser.single_label_return single_label() throws RecognitionException {
		...
		try {
			// CL.g:102:15: ( label ( WS )* CR -> ^( ROW[$single_label.text] label ) )
			// CL.g:103:5: label ( WS )* CR
			{
			...
			{
				// CL.g:103:22: ^( ROW[$single_label.text] label )
				{
				CommonTree root_1 = (CommonTree)adaptor.nil();
	...
	// CL.g:106:1: command_row : ( label )? ( WS )* command CR -> ^( ROW[$command_row.text] ( label )? command ) ;
	public final CLParser.command_row_return command_row() throws RecognitionException {
		...
		try {
			// CL.g:106:12: ( ( label )? ( WS )* command CR -> ^( ROW[$command_row.text] ( label )? command ) )
			// CL.g:107:2: ( label )? ( WS )* command CR
			{
			// CL.g:107:2: ( label )?
			int alt5=2;
			...
			{
				// CL.g:107:30: ^( ROW[$command_row.text] ( label )? command )
				{
				CommonTree root_1 = (CommonTree)adaptor.nil();
				root_1 = (CommonTree)adaptor.becomeRoot((CommonTree)adaptor.create(ROW, input.toString(retval.start,input.LT(-1))), root_1);
				// CL.g:107:55: ( label )?
