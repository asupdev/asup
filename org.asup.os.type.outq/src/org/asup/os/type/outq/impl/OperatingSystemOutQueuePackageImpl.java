...
import org.asup.os.type.outq.QOperatingSystemOutQueueFactory;
...
import org.asup.os.type.outq.SequenceType;
...
public class OperatingSystemOutQueuePackageImpl extends EPackageImpl implements QOperatingSystemOutQueuePackage {
	 ...
	 * @see org.asup.os.type.outq.QOperatingSystemOutQueuePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		EGenericType g2 = createEGenericType(this.getOutQueue());
		g1.getETypeArguments().add(g2);
		outQueueManagerEClass.getEGenericSuperTypes().add(g1);
