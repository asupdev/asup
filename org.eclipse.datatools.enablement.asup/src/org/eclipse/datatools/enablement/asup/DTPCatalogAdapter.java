...
public class DTPCatalogAdapter  implements Catalog, ICatalogObject {

	private Database database;
	
	public DTPCatalogAdapter(Database database) {
...
//		return database.getName();
	...
	public Connection getConnection() {
		return DatabaseConnectionRegistry.getConnectionForDatabase(database).getSharedConnection();
	}
