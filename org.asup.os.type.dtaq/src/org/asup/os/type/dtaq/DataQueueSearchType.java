...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>QData Queue Search Type</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.asup.os.type.dtaq.QOperatingSystemDataQueuePackage#getDataQueueSearchType()
 * @model
 * @generated
 */
public enum DataQueueSearchType implements Enumerator {
	 ...
	 * @generated
	 */
	private static final DataQueueSearchType[] VALUES_ARRAY =
		new DataQueueSearchType[] {
			EQUAL,
			NOT_EQUAL,
			LESS_THAN,
			GREATER_THAN,
