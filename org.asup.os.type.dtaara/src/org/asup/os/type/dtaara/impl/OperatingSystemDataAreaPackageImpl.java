...
import org.asup.os.type.dtaara.QOperatingSystemDataAreaFactory;
...
public class OperatingSystemDataAreaPackageImpl extends EPackageImpl implements QOperatingSystemDataAreaPackage {
	 ...
	 * @see org.asup.os.type.dtaara.QOperatingSystemDataAreaPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		EGenericType g2 = createEGenericType(this.getDataArea());
		g1.getETypeArguments().add(g2);
		dataAreaManagerEClass.getEGenericSuperTypes().add(g1);
