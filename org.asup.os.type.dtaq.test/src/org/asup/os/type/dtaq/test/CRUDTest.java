...
public class CRUDTest extends BaseAssertImpl{
	...
	public void doTest(){
		...
		try
		{
			...
			if (checkObj(job, QDataQueue.class, testLib, lifoDtaq) == false) {
				...
				assertTrue("Create LIFO DTAQ ", checkObj(job, QDataQueue.class, testLib, lifoDtaq));
			} else {
			...
			assertEquals("Read DTAQ FIFO", writeVal1, readVal1);
			assertEquals("Read DTAQ FIFO", writeVal2, readVal2);
			...
			assertEquals("Read DTAQ LIFO", writeVal2, readVal1);
			assertEquals("Read DTAQ LIFO", writeVal1, readVal2);
			...
			assertEquals("Read DTAQ KEYED", writeVal1, readVal1);
			assertEquals("Read DTAQ KEYED", writeVal2, readVal2);
			...
			assertTrue("Delete LIFO DTAQ ", checkObj(job, QDataQueue.class, testLib, lifoDtaq) == false);
