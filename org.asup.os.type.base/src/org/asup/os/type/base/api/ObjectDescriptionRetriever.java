...
public class ObjectDescriptionRetriever {
	...
	public @Entry void main(
			...
			@ToDo @DataDef(length = 13) QCharacter cLVarForSAVDATE13,
			@ToDo @DataDef(length = 13) QCharacter cLVarForSAVACTDATE13,
			@ToDo @DataDef(length = 13) QCharacter cLVarForRSTDATE13,
			@ToDo @DataDef(length = 10) QCharacter cLVarForCRTUSER10,
			@ToDo @DataDef(length = 8) QCharacter cLVarForCRTSYSTEM8,
			@ToDo @DataDef(length = 2) QCharacter cLVarForOBJDMN2,
			@ToDo @DataDef(length = 1) QCharacter cLVarForUSEUPD1,
			@ToDo @DataDef(length = 7) QCharacter cLVarForUSEDATE7,
			@ToDo @DataDef(precision = 5) QDecimal cLVarForUSECOUNT50,
			@ToDo @DataDef(length = 7) QCharacter cLVarForRESETDATE7,
			@ToDo @DataDef(length = 10) QCharacter cLVarForSTG10,
			@ToDo @DataDef(length = 1) QCharacter cLVarForCPR1,
			@ToDo @DataDef(precision = 15) QDecimal cLVarForSIZE150,
			@ToDo @DataDef(precision = 15) QDecimal cLVarForSPCSIZE150,
			@ToDo @DataDef(length = 1) QCharacter cLVarForSPCALIGN1,
			@ToDo @DataDef(precision = 15) QDecimal cLVarForSAVSIZE150,
			@ToDo @DataDef(length = 10) QCharacter cLVarForSAVCMD10,
			@ToDo @DataDef(precision = 4) QDecimal cLVarForSAVSEQNBR40,
			@ToDo @DataDef(precision = 10) QDecimal cLVarForSAVLRGSEQ100,
			@ToDo @DataDef(length = 71) QCharacter cLVarForSAVVOL71,
			@ToDo @DataDef(length = 10) QCharacter cLVarForSAVDEV10,
			@ToDo @DataDef(length = 10) QCharacter cLVarForSAVF10,
			@ToDo @DataDef(length = 10) QCharacter cLVarForSAVFLIB10,
			@ToDo @DataDef(length = 17) QCharacter cLVarForSAVLABEL17,
			...
			@ToDo @DataDef(length = 13) QCharacter cLVarForSRCDATE13,
			@ToDo @DataDef(length = 9) QCharacter cLVarForSYSLVL9,
			@ToDo @DataDef(length = 16) QCharacter cLVarForCOMPILER16,
			@ToDo @DataDef(length = 8) QCharacter cLVarForOBJLVL8,
			@ToDo @DataDef(length = 1) QCharacter cLVarForALWAPICHG1,
			@ToDo @DataDef(length = 1) QCharacter cLVarForAPICHG1,
			@ToDo @DataDef(length = 1) QCharacter cLVarForUSRCHG1,
			@ToDo @DataDef(length = 16) QCharacter cLVarForLICPGM16,
			@ToDo @DataDef(length = 10) QCharacter cLVarForPTF10,
			@ToDo @DataDef(length = 10) QCharacter cLVarForAPAR10,
			@ToDo @DataDef(length = 10) QCharacter cLVarForOBJAUD10,
			@ToDo @DataDef(length = 1) QCharacter cLVarForOBJSIG1,
			@ToDo @DataDef(length = 1) QCharacter cLVarForSYSSIG1,
			@ToDo @DataDef(length = 1) QCharacter cLVarForMLTSIG1,
			@ToDo @DataDef(length = 1) QCharacter cLVarForJRNSTS1,
			@ToDo @DataDef(length = 10) QCharacter cLVarForJRN10,
			@ToDo @DataDef(length = 10) QCharacter cLVarForJRNLIB10,
			@ToDo @DataDef(length = 1) QCharacter cLVarForJRNIMG1,
			@ToDo @DataDef(length = 1) QCharacter cLVarForJRNOMTE1,
			@ToDo @DataDef(length = 13) QCharacter cLVarForJRNSTRDATE13,
			@ToDo @DataDef(length = 10) QCharacter cLVarForSTRJRNRCV10,
