...
import org.asup.os.type.usrspc.QOperatingSystemUserSpaceFactory;
...
public class OperatingSystemUserSpacePackageImpl extends EPackageImpl implements QOperatingSystemUserSpacePackage {
	 ...
	 * @see org.asup.os.type.usrspc.QOperatingSystemUserSpacePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		EGenericType g2 = createEGenericType(this.getUserSpace());
		g1.getETypeArguments().add(g2);
		userSpaceManagerEClass.getEGenericSuperTypes().add(g1);
