 ...
 * <ul>
 *   <li>{@link org.asup.il.flow.QUnit#getName <em>Name</em>}</li>
 *   <li>{@link org.asup.il.flow.QUnit#getMain <em>Main</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.asup.il.flow.QIntegratedLanguageFlowPackage#getUnit()
 * @model abstract="true"
 * @generated
 */
public interface QUnit extends QNamedNode {
	 ...
	 * @see #setName(String)
	 * @see org.asup.il.flow.QIntegratedLanguageFlowPackage#getUnit_Name()
	 * @model
	 * @generated
	 */
	String getName();
	...
	/**
	 * Sets the value of the '{@link org.asup.il.flow.QUnit#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
