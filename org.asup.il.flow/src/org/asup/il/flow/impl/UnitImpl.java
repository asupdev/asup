 ...
 * <ul>
 *   <li>{@link org.asup.il.flow.impl.UnitImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.asup.il.flow.impl.UnitImpl#getMain <em>Main</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class UnitImpl extends NamedNodeImpl implements QUnit {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetMain(QBlock newMain, NotificationChain msgs) {
		QBlock oldMain = main;
		main = newMain;
		if (eNotificationRequired()) {
	 ...
	 * @generated
	 */
	public void setMain(QBlock newMain) {
		if (newMain != main) {
