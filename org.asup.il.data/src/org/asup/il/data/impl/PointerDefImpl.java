 ...
 * <ul>
 *   <li>{@link org.asup.il.data.impl.PointerDefImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PointerDefImpl extends UnaryAtomicBufferedDataDefImpl<QPointer> implements QPointerDef {
	...
	public void setTarget(String newTarget) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QIntegratedLanguageDataPackage.POINTER_DEF__TARGET, oldTarget, target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QIntegratedLanguageDataPackage.POINTER_DEF__TARGET:
				return getTarget();
		}
