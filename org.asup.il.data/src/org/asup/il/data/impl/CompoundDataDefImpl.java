...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Compound Data Def</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.asup.il.data.impl.CompoundDataDefImpl#getClassDelegator <em>Class Delegator</em>}</li>
 *   <li>{@link org.asup.il.data.impl.CompoundDataDefImpl#getElements <em>Elements</em>}</li>
 *   <li>{@link org.asup.il.data.impl.CompoundDataDefImpl#getPrefix <em>Prefix</em>}</li>
 *   <li>{@link org.asup.il.data.impl.CompoundDataDefImpl#isQualified <em>Qualified</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class CompoundDataDefImpl<D extends QStruct<?>> extends DataDefImpl<D> implements QCompoundDataDef<D> {
	...
	protected EClass eStaticClass() {
		return QIntegratedLanguageDataPackage.Literals.COMPOUND_DATA_DEF;
	}
	...
	public void setClassDelegator(String newClassDelegator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QIntegratedLanguageDataPackage.COMPOUND_DATA_DEF__CLASS_DELEGATOR, oldClassDelegator, classDelegator));
	}
	...
	public List<QDataTerm<?>> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentEList<QDataTerm<?>>(QDataTerm.class, this, QIntegratedLanguageDataPackage.COMPOUND_DATA_DEF__ELEMENTS);
		}
		return elements;
	}
	...
	public void setPrefix(String newPrefix) {
		...
		prefix = newPrefix;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QIntegratedLanguageDataPackage.COMPOUND_DATA_DEF__PREFIX, oldPrefix, prefix));
	}
	...
	public void setQualified(boolean newQualified) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QIntegratedLanguageDataPackage.COMPOUND_DATA_DEF__QUALIFIED, oldQualified, qualified));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case QIntegratedLanguageDataPackage.COMPOUND_DATA_DEF__ELEMENTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QIntegratedLanguageDataPackage.COMPOUND_DATA_DEF__CLASS_DELEGATOR:
				return getClassDelegator();
			case QIntegratedLanguageDataPackage.COMPOUND_DATA_DEF__ELEMENTS:
				return getElements();
			case QIntegratedLanguageDataPackage.COMPOUND_DATA_DEF__PREFIX:
				return getPrefix();
			case QIntegratedLanguageDataPackage.COMPOUND_DATA_DEF__QUALIFIED:
				return isQualified();
		}
