 ...
 * <ul>
 *   <li>{@link org.asup.il.data.impl.MultipleAtomicDataDefImpl#getArgument <em>Argument</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class MultipleAtomicDataDefImpl<D extends QList<?>> extends MultipleDataDefImpl<D> implements QMultipleAtomicDataDef<D> {
	...
	public NotificationChain basicSetArgument(QUnaryAtomicDataDef<?> newArgument, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, QIntegratedLanguageDataPackage.MULTIPLE_ATOMIC_DATA_DEF__ARGUMENT, oldArgument, newArgument);
	...
	public void setArgument(QUnaryAtomicDataDef<?> newArgument) {
		if (newArgument != argument) {
			...
			if (argument != null)
				msgs = ((InternalEObject)argument).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - QIntegratedLanguageDataPackage.MULTIPLE_ATOMIC_DATA_DEF__ARGUMENT, null, msgs);
			if (newArgument != null)
				msgs = ((InternalEObject)newArgument).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - QIntegratedLanguageDataPackage.MULTIPLE_ATOMIC_DATA_DEF__ARGUMENT, null, msgs);
			msgs = basicSetArgument(newArgument, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QIntegratedLanguageDataPackage.MULTIPLE_ATOMIC_DATA_DEF__ARGUMENT, newArgument, newArgument));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case QIntegratedLanguageDataPackage.MULTIPLE_ATOMIC_DATA_DEF__ARGUMENT:
