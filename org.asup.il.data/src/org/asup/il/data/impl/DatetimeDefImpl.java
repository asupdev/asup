 ...
 * <ul>
 *   <li>{@link org.asup.il.data.impl.DatetimeDefImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.asup.il.data.impl.DatetimeDefImpl#getFormat <em>Format</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DatetimeDefImpl extends UnaryAtomicBufferedDataDefImpl<QDatetime> implements QDatetimeDef {
	...
	protected EClass eStaticClass() {
		return QIntegratedLanguageDataPackage.Literals.DATETIME_DEF;
	}
	...
	public void setType(DatetimeType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QIntegratedLanguageDataPackage.DATETIME_DEF__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QIntegratedLanguageDataPackage.DATETIME_DEF__TYPE:
				return getType();
			case QIntegratedLanguageDataPackage.DATETIME_DEF__FORMAT:
				return getFormat();
		}
