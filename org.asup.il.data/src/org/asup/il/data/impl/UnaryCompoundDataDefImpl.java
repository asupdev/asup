...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Unary Compound Data Def</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.asup.il.data.impl.UnaryCompoundDataDefImpl#getClassDelegator <em>Class Delegator</em>}</li>
 *   <li>{@link org.asup.il.data.impl.UnaryCompoundDataDefImpl#getElements <em>Elements</em>}</li>
 *   <li>{@link org.asup.il.data.impl.UnaryCompoundDataDefImpl#getPrefix <em>Prefix</em>}</li>
 *   <li>{@link org.asup.il.data.impl.UnaryCompoundDataDefImpl#isQualified <em>Qualified</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class UnaryCompoundDataDefImpl<D extends QStruct<?>> extends UnaryDataDefImpl<D> implements QUnaryCompoundDataDef<D> {
	...
	protected EClass eStaticClass() {
		return QIntegratedLanguageDataPackage.Literals.UNARY_COMPOUND_DATA_DEF;
	}
	...
	public void setClassDelegator(String newClassDelegator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QIntegratedLanguageDataPackage.UNARY_COMPOUND_DATA_DEF__CLASS_DELEGATOR, oldClassDelegator, classDelegator));
	}
	...
	public List<QDataTerm<?>> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentEList<QDataTerm<?>>(QDataTerm.class, this, QIntegratedLanguageDataPackage.UNARY_COMPOUND_DATA_DEF__ELEMENTS);
		}
		return elements;
	}
	...
	public void setPrefix(String newPrefix) {
		...
		prefix = newPrefix;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QIntegratedLanguageDataPackage.UNARY_COMPOUND_DATA_DEF__PREFIX, oldPrefix, prefix));
	}
	...
	public void setQualified(boolean newQualified) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QIntegratedLanguageDataPackage.UNARY_COMPOUND_DATA_DEF__QUALIFIED, oldQualified, qualified));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case QIntegratedLanguageDataPackage.UNARY_COMPOUND_DATA_DEF__ELEMENTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QIntegratedLanguageDataPackage.UNARY_COMPOUND_DATA_DEF__CLASS_DELEGATOR:
				return getClassDelegator();
			case QIntegratedLanguageDataPackage.UNARY_COMPOUND_DATA_DEF__ELEMENTS:
				return getElements();
			case QIntegratedLanguageDataPackage.UNARY_COMPOUND_DATA_DEF__PREFIX:
				return getPrefix();
			case QIntegratedLanguageDataPackage.UNARY_COMPOUND_DATA_DEF__QUALIFIED:
				return isQualified();
		}
