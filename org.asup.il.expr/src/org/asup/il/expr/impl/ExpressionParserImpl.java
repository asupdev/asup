...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Expression Parser</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.asup.il.expr.impl.ExpressionParserImpl#getConfig <em>Config</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class ExpressionParserImpl extends PluginImpl implements QExpressionParser {
	/**
	 ...
	 * @generated
	 */
	protected ExpressionParserImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return QIntegratedLanguageExpressionPackage.Literals.EXPRESSION_PARSER;
	}
	...
	public NotificationChain basicSetConfig(QServiceConfig newConfig, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, QIntegratedLanguageExpressionPackage.EXPRESSION_PARSER__CONFIG, oldConfig, newConfig);
	...
	public void setConfig(QServiceConfig newConfig) {
		if (newConfig != config) {
			...
			if (config != null)
				msgs = ((InternalEObject)config).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - QIntegratedLanguageExpressionPackage.EXPRESSION_PARSER__CONFIG, null, msgs);
			if (newConfig != null)
				msgs = ((InternalEObject)newConfig).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - QIntegratedLanguageExpressionPackage.EXPRESSION_PARSER__CONFIG, null, msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case QIntegratedLanguageExpressionPackage.EXPRESSION_PARSER__CONFIG:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == QService.class) {
			switch (derivedFeatureID) {
				case QIntegratedLanguageExpressionPackage.EXPRESSION_PARSER__CONFIG: return QFrameworkCorePackage.SERVICE__CONFIG;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == QService.class) {
			switch (baseFeatureID) {
				case QFrameworkCorePackage.SERVICE__CONFIG: return QIntegratedLanguageExpressionPackage.EXPRESSION_PARSER__CONFIG;
				default: return -1;
			}
		}
