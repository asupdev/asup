...
public class IntegratedLanguageExpressionPackageImpl extends EPackageImpl implements QIntegratedLanguageExpressionPackage {
	 ...
	 * @generated
	 */
	private EDataType ilExpressionExceptionEDataType = null;
	 ...
	 * @generated
	 */
	private EDataType ilExpressionRuntimeExceptionEDataType = null;
	 ...
	 * @see org.asup.il.expr.QIntegratedLanguageExpressionPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EDataType getILExpressionException() {
		return ilExpressionExceptionEDataType;
	}
	 ...
	 * @generated
	 */
	public EDataType getILExpressionRuntimeException() {
		return ilExpressionRuntimeExceptionEDataType;
	}
	...
	public void createPackageContents() {
		...
		// Create data types
		ilExpressionExceptionEDataType = createEDataType(IL_EXPRESSION_EXCEPTION);
		ilExpressionRuntimeExceptionEDataType = createEDataType(IL_EXPRESSION_RUNTIME_EXCEPTION);
	}
	...
	public void initializePackageContents() {
		...
		expressionParserEClass.getESuperTypes().add(theFrameworkCorePackage.getPlugin());
		expressionParserEClass.getESuperTypes().add(theFrameworkCorePackage.getService());
		...
		initEDataType(ilExpressionExceptionEDataType, IntegratedLanguageExpressionException.class, "ILExpressionException", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
		initEDataType(ilExpressionRuntimeExceptionEDataType, IntegratedLanguageExpressionRuntimeException.class, "ILExpressionRuntimeException", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
