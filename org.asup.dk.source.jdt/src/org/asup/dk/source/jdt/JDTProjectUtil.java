...
//	private static final String PDE_NATURE = "org.eclipse.pde.PluginNature";
    ...
    public static IJavaProject createAsupProject(IProject project, String name, String text) throws CoreException, IOException {
		...
		attributes.putValue("Require-Bundle", "org.asup.os.core, org.asup.db.core, org.asup.il.data, org.asup.il.isam, org.asup.il.flow, org.asup.os.type.pgm, org.asup.os.type.file, SMESYS, SMETAB, SMEUP_DAT");
