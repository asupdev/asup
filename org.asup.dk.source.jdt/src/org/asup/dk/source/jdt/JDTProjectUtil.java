...
//	private static final String PDE_NATURE = "org.eclipse.pde.PluginNature";
    ...
    public static IJavaProject createAsupProject(IProject project, String name, String text) throws CoreException, IOException {
		...
		attributes.putValue("Bundle-Version", "0.5.4.qualifier");
		attributes.putValue("Require-Bundle", "org.asup.os.core, org.asup.db.core, org.asup.il.data, org.asup.il.isam, org.asup.il.flow, org.asup.os.type.pgm, org.asup.os.type.file, com.smeup.erp.gen.file.dbf, com.smeup.erp.gen.file.dspf, com.smeup.erp.gen.file.prtf, com.smeup.erp.gen.sqlpkg, com.smeup.erp.gen.module, com.smeup.erp.gen.pgm");
