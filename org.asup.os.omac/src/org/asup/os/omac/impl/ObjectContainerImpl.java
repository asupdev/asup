 ...
 * <ul>
 *   <li>{@link org.asup.os.omac.impl.ObjectContainerImpl#getContents <em>Contents</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ObjectContainerImpl<T extends QObject> extends MinimalEObjectImpl.Container implements QObjectContainer<T> {
	...
	protected EClass eStaticClass() {
		return QOperatingSystemOmacPackage.Literals.OBJECT_CONTAINER;
	}
	...
	public List<T> getContents() {
		if (contents == null) {
			contents = new EObjectContainmentEList<T>(QObject.class, this, QOperatingSystemOmacPackage.OBJECT_CONTAINER__CONTENTS);
		}
		return contents;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case QOperatingSystemOmacPackage.OBJECT_CONTAINER__CONTENTS:
