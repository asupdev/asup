 ...
 * @param checkStmtOnly
 */
IBMiQueryParser( LexStream lexStream,
               IBMiQueryParserFactory factory,
...
IBMiQueryParser(LexStream lexStream, IBMiQueryParserFactory factory, SQLQuerySourceFormat sourceFormat)
throws SQLParserInternalException
{
    this(lexStream, factory, sourceFormat, false);
}

IBMiQueryParser(LexStream lexStream, IBMiQueryParserFactory factory)
throws SQLParserInternalException
{
    this(lexStream, factory, SQLQuerySourceFormat.copyDefaultFormat());
}

IBMiQueryParser(LexStream lexStream, IBMiQueryParserFactory factory, boolean checkStmtOnly)
throws SQLParserInternalException
{
...
public String[] orderedTerminalSymbols() { return IBMiQueryParsersym.orderedTerminalSymbols; }
...
public void ruleAction( int ruleNumber)
{
    switch(ruleNumber)
    {
        ...
        case 4: 
        {
	    	...
	    	if (hasComments()) extendSpanToFollowingToken((QueryStatement) getSym(1), IBMiQueryParsersym.TK_STATEMENT_TERMINATOR);
        ...
        case 12: 
        {
            ...
            setSym1(m_factory.createPredicateQuantifiedValueSelect((QueryValueExpression)getSym(1),getInt(2),IBMiQueryParserFactory.QUANTIFIER_ANY,(QueryExpressionRoot)getSym(4))); 
        }
        break;  
        ...
        case 13: 
        {
            ...
            setSym1(m_factory.createPredicateQuantifiedValueSelect((QueryValueExpression)getSym(1),getInt(2),IBMiQueryParserFactory.QUANTIFIER_SOME,(QueryExpressionRoot)getSym(4))); 
        }
        break;  
        ...
        case 14: 
        {
            ...
            setSym1(m_factory.createPredicateQuantifiedValueSelect((QueryValueExpression)getSym(1),getInt(2),IBMiQueryParserFactory.QUANTIFIER_ALL,(QueryExpressionRoot)getSym(4))); 
        }
        break;  
        ...
        case 15: 
        {
            ...
            setSym1(m_factory.createPredicateQuantifiedRowSelect(getList(2),IBMiQueryParserFactory.QUANTIFIER_ANY,(QueryExpressionRoot)getSym(6))); 
        }
        break;  
        ...
        case 16: 
        {
            ...
            setSym1(m_factory.createPredicateQuantifiedRowSelect(getList(2),IBMiQueryParserFactory.QUANTIFIER_SOME,(QueryExpressionRoot)getSym(6))); 
        }
        break;  
        ...
        case 25: 
        {
            if (checkStmtOnly) {
				...
				setSym1(m_factory.createCombinedCondition((QuerySearchCondition)getSym(1), (QuerySearchCondition)getSym(3), IBMiQueryParserFactory.COMBINED_OPERATOR_OR)); 
        }
        break;   
        /*
        ...
        case 27: 
        {
            ...
            setSym1(m_factory.createCombinedCondition((QuerySearchCondition)getSym(1), (QuerySearchCondition)getSym(3), IBMiQueryParserFactory.COMBINED_OPERATOR_AND)); 
        }
        break;  
        ...
        case 81: 
        {
            ...
            setSym1(m_factory.createDataTypeTime( IBMiQueryParserFactory.PRIMITIVE_TYPE_TIME, 0, DataTypeHelper.TYPENAME_TIME )); 
        }
        break;  
        ...
        case 82: 
        {
            ...
            setSym1(m_factory.createDataTypeTime( IBMiQueryParserFactory.PRIMITIVE_TYPE_TIMESTAMP, 0, DataTypeHelper.TYPENAME_TIMESTAMP )); 
        }
        break;  
        ...
        case 87: 
        {
            ...
            setSym1(m_factory.createDataTypeNumericApproximate( IBMiQueryParserFactory.PRIMITIVE_TYPE_FLOAT, 0, DataTypeHelper.TYPENAME_FLOAT)); 
        }
        break;  
        ...
        case 88: 
        {
            ...
            setSym1(m_factory.createDataTypeNumericApproximate( IBMiQueryParserFactory.PRIMITIVE_TYPE_FLOAT, Integer.parseInt(getTokenName(3)), DataTypeHelper.TYPENAME_FLOAT )); 
        }
        break;  
        ...
        case 89: 
        {
            ...
            setSym1(m_factory.createDataTypeNumericApproximate( IBMiQueryParserFactory.PRIMITIVE_TYPE_REAL, 0, DataTypeHelper.TYPENAME_REAL)); 
        }
        break;  
        ...
        case 90: 
        {
            ...
            setSym1(m_factory.createDataTypeNumericApproximate( IBMiQueryParserFactory.PRIMITIVE_TYPE_DOUBLE_PRECISION, 0, DataTypeHelper.TYPENAME_DOUBLE )); 
        }
        break;  
        ...
        case 91: 
        {
            ...
            setSym1(m_factory.createDataTypeNumericApproximate( IBMiQueryParserFactory.PRIMITIVE_TYPE_DOUBLE_PRECISION, 0, DataTypeHelper.TYPENAME_DOUBLE_PRECISION )); 
        }
        break;  
        ...
        case 92: 
        {
            ...
            setSym1(m_factory.createDataTypeNumericFixedPrecision( IBMiQueryParserFactory.PRIMITIVE_TYPE_NUMERIC, 0, 0, DataTypeHelper.TYPENAME_NUMERIC)); 
        }
        break;  
        ...
        case 93: 
        {
            ...
            setSym1(m_factory.createDataTypeNumericFixedPrecision( IBMiQueryParserFactory.PRIMITIVE_TYPE_DECIMAL, 0, 0, DataTypeHelper.TYPENAME_DECIMAL)); 
        }
        break;  
        ...
        case 94: 
        {
            ...
            setSym1(m_factory.createDataTypeNumericFixedPrecision( IBMiQueryParserFactory.PRIMITIVE_TYPE_DECIMAL, 0, 0, DataTypeHelper.TYPENAME_DEC)); 
        }
        break;  
        ...
        case 95: 
        {
            ...
            setSym1(m_factory.createDataTypeNumericFixedPrecision( IBMiQueryParserFactory.PRIMITIVE_TYPE_NUMERIC, Integer.parseInt(getTokenName(3)), 0, DataTypeHelper.TYPENAME_NUMERIC)); 
        }
        break;  
        ...
        case 96: 
        {
            ...
            setSym1(m_factory.createDataTypeNumericFixedPrecision( IBMiQueryParserFactory.PRIMITIVE_TYPE_DECIMAL, Integer.parseInt(getTokenName(3)), 0, DataTypeHelper.TYPENAME_DECIMAL)); 
        }
        break;  
        ...
        case 97: 
        {
            ...
            setSym1(m_factory.createDataTypeNumericFixedPrecision( IBMiQueryParserFactory.PRIMITIVE_TYPE_DECIMAL, Integer.parseInt(getTokenName(3)), 0, DataTypeHelper.TYPENAME_DEC)); 
        }
        break;  
        ...
        case 98: 
        {
            ...
            setSym1(m_factory.createDataTypeNumericFixedPrecision( IBMiQueryParserFactory.PRIMITIVE_TYPE_NUMERIC, Integer.parseInt(getTokenName(3)), Integer.parseInt(getTokenName(5)), DataTypeHelper.TYPENAME_NUMERIC )); 
        }
        break;  
        ...
        case 99: 
        {
            ...
            setSym1(m_factory.createDataTypeNumericFixedPrecision( IBMiQueryParserFactory.PRIMITIVE_TYPE_DECIMAL, Integer.parseInt(getTokenName(3)), Integer.parseInt(getTokenName(5)), DataTypeHelper.TYPENAME_DECIMAL )); 
        }
        break;  
        ...
        case 100: 
        {
            ...
            setSym1(m_factory.createDataTypeNumericFixedPrecision( IBMiQueryParserFactory.PRIMITIVE_TYPE_DECIMAL, Integer.parseInt(getTokenName(3)), Integer.parseInt(getTokenName(5)), DataTypeHelper.TYPENAME_DEC )); 
        }
        break;  
        ...
        case 101: 
        {
            ...
            setSym1(m_factory.createDataTypeNumericInteger( IBMiQueryParserFactory.PRIMITIVE_TYPE_INTEGER, 0, DataTypeHelper.TYPENAME_INTEGER )); 
        }
        break;  
        ...
        case 102: 
        {
            ...
            setSym1(m_factory.createDataTypeNumericInteger( IBMiQueryParserFactory.PRIMITIVE_TYPE_INTEGER, 0, DataTypeHelper.TYPENAME_INT )); 
        }
        break;  
        ...
        case 103: 
        {
            ...
            setSym1(m_factory.createDataTypeNumericInteger( IBMiQueryParserFactory.PRIMITIVE_TYPE_SMALLINT, 0, DataTypeHelper.TYPENAME_SMALLINT )); 
        }
        break;  
        ...
        case 104: 
        {
            ...
            setSym1(m_factory.createDataTypeNumericInteger( IBMiQueryParserFactory.PRIMITIVE_TYPE_BIGINT, 0, DataTypeHelper.TYPENAME_BIGINT )); 
        }
        break;  
        ...
        case 105: 
        {
            ...
            setSym1(m_factory.createDataTypeBinaryString( IBMiQueryParserFactory.PRIMITIVE_TYPE_BINARY_LARGE_OBJECT, 0, null, DataTypeHelper.TYPENAME_BLOB )); 
        }
        break;  
        ...
        case 106: 
        {
            ...
            setSym1(m_factory.createDataTypeBinaryString( IBMiQueryParserFactory.PRIMITIVE_TYPE_BINARY_LARGE_OBJECT, Integer.parseInt(getTokenName(3)), getString(4), DataTypeHelper.TYPENAME_BLOB )); 
        }
        break;  
        ...
        case 107: 
        {
            ...
            setSym1(m_factory.createDataTypeBinaryString( IBMiQueryParserFactory.PRIMITIVE_TYPE_BINARY_LARGE_OBJECT, 0, null, DataTypeHelper.TYPENAME_BINARY_LARGE_OBJECT )); 
        }
        break;  
        ...
        case 108: 
        {
            ...
            setSym1(m_factory.createDataTypeBinaryString( IBMiQueryParserFactory.PRIMITIVE_TYPE_BINARY_LARGE_OBJECT, Integer.parseInt(getTokenName(3)), getString(4), DataTypeHelper.TYPENAME_BINARY_LARGE_OBJECT )); 
        }
        break;  
        ...
        case 109: 
        {
            ...
            setSym1(m_factory.createDataTypeCharacterString( IBMiQueryParserFactory.PRIMITIVE_TYPE_CHARACTER, 0, null, DataTypeHelper.TYPENAME_CHARACTER )); 
        }
        break;  
        ...
        case 110: 
        {
            ...
            setSym1(m_factory.createDataTypeCharacterString( IBMiQueryParserFactory.PRIMITIVE_TYPE_CHARACTER, 0, null, DataTypeHelper.TYPENAME_CHAR )); 
        }
        break;  
        ...
        case 111: 
        {
            ...
            setSym1(m_factory.createDataTypeCharacterString( IBMiQueryParserFactory.PRIMITIVE_TYPE_CHARACTER, Integer.parseInt(getTokenName(3)), null, DataTypeHelper.TYPENAME_CHARACTER )); 
        }
        break;  
        ...
        case 112: 
        {
            ...
            setSym1(m_factory.createDataTypeCharacterString( IBMiQueryParserFactory.PRIMITIVE_TYPE_CHARACTER, Integer.parseInt(getTokenName(3)), null, DataTypeHelper.TYPENAME_CHAR )); 
        }
        break;  
        ...
        case 113: 
        {
            ...
            setSym1(m_factory.createDataTypeCharacterString( IBMiQueryParserFactory.PRIMITIVE_TYPE_CHARACTER_VARYING, Integer.parseInt(getTokenName(4)), null, DataTypeHelper.TYPENAME_CHARACTER_VARYING )); 
        }
        break;  
        ...
        case 114: 
        {
            ...
            setSym1(m_factory.createDataTypeCharacterString( IBMiQueryParserFactory.PRIMITIVE_TYPE_CHARACTER_VARYING, Integer.parseInt(getTokenName(4)), null, DataTypeHelper.TYPENAME_CHAR_VARYING )); 
        }
        break;  
        ...
        case 115: 
        {
            ...
            setSym1(m_factory.createDataTypeCharacterString( IBMiQueryParserFactory.PRIMITIVE_TYPE_CHARACTER_VARYING, Integer.parseInt(getTokenName(3)), null, DataTypeHelper.TYPENAME_VARCHAR )); 
        }
        break;  
        ...
        case 116: 
        {
            ...
            setSym1(m_factory.createDataTypeCharacterString( IBMiQueryParserFactory.PRIMITIVE_TYPE_CHARACTER_LARGE_OBJECT, 0, null, DataTypeHelper.TYPENAME_CLOB )); 
        }
        break;  
        ...
        case 117: 
        {
            ...
            setSym1(m_factory.createDataTypeCharacterString( IBMiQueryParserFactory.PRIMITIVE_TYPE_CHARACTER_LARGE_OBJECT, Integer.parseInt(getTokenName(3)), getString(4), DataTypeHelper.TYPENAME_CLOB )); 
        }
        break;  
        ...
        case 118: 
        {
            ...
            setSym1(m_factory.createDataTypeCharacterString( IBMiQueryParserFactory.PRIMITIVE_TYPE_CHARACTER_LARGE_OBJECT, 0, null, DataTypeHelper.TYPENAME_CHARACTER_LARGE_OBJECT )); 
        }
        break;  
        ...
        case 119: 
        {
            ...
            setSym1(m_factory.createDataTypeCharacterString( IBMiQueryParserFactory.PRIMITIVE_TYPE_CHARACTER_LARGE_OBJECT, Integer.parseInt(getTokenName(5)), getString(6), DataTypeHelper.TYPENAME_CHARACTER_LARGE_OBJECT )); 
        }
        break;  
        ...
        case 120: 
        {
            ...
            setSym1(m_factory.createDataTypeCharacterString( IBMiQueryParserFactory.PRIMITIVE_TYPE_CHARACTER_LARGE_OBJECT, 0, null, DataTypeHelper.TYPENAME_CHAR_LARGE_OBJECT )); 
        }
        break;  
        ...
        case 121: 
        {
            if (checkStmtOnly) {
           	...
           	setSym1(m_factory.createDataTypeCharacterString( IBMiQueryParserFactory.PRIMITIVE_TYPE_CHARACTER_LARGE_OBJECT, Integer.parseInt(getTokenName(5)), getString(6), DataTypeHelper.TYPENAME_CHAR_LARGE_OBJECT )); 
        }
        break;  
        ...
        case 122: 
        {
            ...
            setSym1(m_factory.createDataTypeCharacterString( IBMiQueryParserFactory.PRIMITIVE_TYPE_NATIONAL_CHARACTER, 0, null, DataTypeHelper.TYPENAME_GRAPHIC )); 
        }
        break;  
        ...
        case 123: 
        {
            ...
            setSym1(m_factory.createDataTypeCharacterString( IBMiQueryParserFactory.PRIMITIVE_TYPE_NATIONAL_CHARACTER, Integer.parseInt(getTokenName(3)), null, DataTypeHelper.TYPENAME_GRAPHIC )); 
        }
        break;  
        ...
        case 124: 
        {
            ...
            setSym1(m_factory.createDataTypeCharacterString( IBMiQueryParserFactory.PRIMITIVE_TYPE_NATIONAL_CHARACTER_VARYING, Integer.parseInt(getTokenName(3)), null, DataTypeHelper.TYPENAME_VARGRAPHIC )); 
        }
        break;  
        ...
        case 125: 
        {
            ...
            setSym1(m_factory.createDataTypeCharacterString( IBMiQueryParserFactory.PRIMITIVE_TYPE_NATIONAL_CHARACTER_LARGE_OBJECT, 0, null, DataTypeHelper.TYPENAME_DBCLOB )); 
        }
        break;  
        ...
        case 126: 
        {
            ...
            setSym1(m_factory.createDataTypeCharacterString( IBMiQueryParserFactory.PRIMITIVE_TYPE_NATIONAL_CHARACTER_LARGE_OBJECT, Integer.parseInt(getTokenName(3)), getString(4), DataTypeHelper.TYPENAME_DBCLOB )); 
        }
        break;  
        ...
        case 134: 
        {
            ...
            setSym1(m_factory.createSpecialRegisterExpression(IBMiQueryParserFactory.SPECIAL_REGISTER_USER)); 
        }
        break;  
        ...
        case 135: 
        {
            ...
            setSym1(m_factory.createSpecialRegisterExpression(IBMiQueryParserFactory.SPECIAL_REGISTER_CURRENT_USER)); 
        }
        break;  
        ...
        case 136: 
        {
            ...
            setSym1(m_factory.createSpecialRegisterExpression(IBMiQueryParserFactory.SPECIAL_REGISTER_CURRENT_ROLE)); 
        }
        break;  
        ...
        case 137: 
        {
            ...
            setSym1(m_factory.createSpecialRegisterExpression(IBMiQueryParserFactory.SPECIAL_REGISTER_SESSION_USER)); 
        }
        break;  
        ...
        case 138: 
        {
            ...
            setSym1(m_factory.createSpecialRegisterExpression(IBMiQueryParserFactory.SPECIAL_REGISTER_SYSTEM_USER)); 
        }
        break;  
        ...
        case 139: 
        {
            ...
            setSym1(m_factory.createSpecialRegisterExpression(IBMiQueryParserFactory.SPECIAL_REGISTER_CURRENT_PATH)); 
        }
        break;  
        ...
        case 143: 
        {
            ...
            setInt1(IBMiQueryParserFactory.DURATION_TYPE_DAYS); 
        }
        break;  
        ...
        case 144: 
        {
            ...
            setInt1(IBMiQueryParserFactory.DURATION_TYPE_HOURS); 
        }
        break;  
        ...
        case 145: 
        {
            ...
            setInt1(IBMiQueryParserFactory.DURATION_TYPE_MICROSECONDS); 
        }
        break;  
        ...
        case 146: 
        {
            ...
            setInt1(IBMiQueryParserFactory.DURATION_TYPE_MINUTES); 
        }
        break;  
        ...
        case 147: 
        {
            ...
            setInt1(IBMiQueryParserFactory.DURATION_TYPE_MONTHS); 
        }
        break;  
        ...
        case 148: 
        {
            ...
            setInt1(IBMiQueryParserFactory.DURATION_TYPE_SECONDS); 
        }
        break;  
        ...
        case 149: 
        {
            ...
            setInt1(IBMiQueryParserFactory.DURATION_TYPE_YEARS); 
        }
        break;  
        ...
        case 151: 
        {
            ...
            setSym1(m_factory.createCombinedExpression((QueryValueExpression) getSym(1),IBMiQueryParserFactory.COMBINED_OPERATOR_ADD,(QueryValueExpression) getSym(3))); 
        }
        break;  
        ...
        case 152: 
        {
            ...
            setSym1(m_factory.createCombinedExpression((QueryValueExpression) getSym(1),IBMiQueryParserFactory.COMBINED_OPERATOR_SUBTRACT,(QueryValueExpression) getSym(3))); 
        }
        break;  
        ...
        case 167: 
        {
            ...
            setSym1( m_factory.setUnaryOperator((QueryValueExpression)getSym(2),IBMiQueryParserFactory.UNARY_OPERATOR_PLUS) ); 
        }
        break;  
        ...
        case 168: 
        {
            ...
            setSym1( m_factory.setUnaryOperator((QueryValueExpression)getSym(2),IBMiQueryParserFactory.UNARY_OPERATOR_MINUS) ); 
        }
        break;  
        ...
        case 171: 
        {
            ...
            setSym1(m_factory.createCombinedExpression((QueryValueExpression) getSym(1),IBMiQueryParserFactory.COMBINED_OPERATOR_MULTIPLY,(QueryValueExpression) getSym(3))); 
        }
        break;  
        ...
        case 172: 
        {
            ...
            setSym1(m_factory.createCombinedExpression((QueryValueExpression) getSym(1),IBMiQueryParserFactory.COMBINED_OPERATOR_DIVIDE,(QueryValueExpression) getSym(3))); 
        }
        break;  
        ...
        case 173: 
        {
            ...
            setSym1(m_factory.createCombinedExpression((QueryValueExpression) getSym(1),IBMiQueryParserFactory.COMBINED_OPERATOR_CONCATENATE,(QueryValueExpression) getSym(3))); 
        }
        break;  
        ...
        case 235: 
        {
            ...
            setSym1(IBMiQueryParserFactory.ALL); 
        }
        break;  
        ...
        case 236: 
        {
            ...
            setSym1(IBMiQueryParserFactory.DISTINCT); 
        }
        break;  
        ...
        case 247: 
        {
            ...
            setInt1(IBMiQueryParserFactory.ORDERING_SPEC_TYPE_ASC); 
        }
        break;  
        ...
        case 248: 
        {
            ...
            setInt1(IBMiQueryParserFactory.ORDERING_SPEC_TYPE_DESC); 
        }
        break;  
        ...
        case 249: 
        {
            ...
            setInt1(IBMiQueryParserFactory.ORDERING_SPEC_TYPE_NONE); 
        }
        break;  
        ...
        case 263: 
        {
            ...
            setSym1( m_factory.createGroupingSpecificationList(null, m_factory.createSuperGroups(getList(3),IBMiQueryParserFactory.SUPERGROUP_TYPE_CUBE)) ); 
        }
        break;  
        ...
        case 264: 
        {
            ...
            setSym1( m_factory.createGroupingSpecificationList(null, m_factory.createSuperGroups(getList(3),IBMiQueryParserFactory.SUPERGROUP_TYPE_ROLLUP)) ); 
        }
        break;  
        ...
        case 268: 
        {
            ...
            setInt1(IBMiQueryParserFactory.JOIN_EXPLICIT_INNER); 
        }
        break;  
        ...
        case 269: 
        {
            ...
            setInt1(IBMiQueryParserFactory.JOIN_LEFT_OUTER); 
        }
        break;  
        ...
        case 270: 
        {
            ...
            setInt1(IBMiQueryParserFactory.JOIN_RIGHT_OUTER); 
        }
        break;  
        ...
        case 271: 
        {
            ...
            setInt1(IBMiQueryParserFactory.JOIN_FULL_OUTER); 
        }
        break;  
        ...
        case 272: 
        {
            ...
            setInt1(IBMiQueryParserFactory.JOIN_DEFAULT_INNER); 
        }
        break;  
        ...
        case 275: 
        {
            ...
            setInt1(IBMiQueryParserFactory.NULL_ORDERING_TYPE_NULLS_FIRST); 
        }
        break;  
        ...
        case 276: 
        {
            ...
            setInt1(IBMiQueryParserFactory.NULL_ORDERING_TYPE_NULLS_LAST); 
        }
        break;  
        ...
        case 277: 
        {
            ...
            setInt1(IBMiQueryParserFactory.NULL_ORDERING_TYPE_NONE); 
        }
        break;  
        ...
        case 303: 
        {
            ...
            setInt1(IBMiQueryParserFactory.QUERY_COMBINED_UNION); 
        }
        break;  
        ...
        case 304: 
        {
            ...
            setInt1(IBMiQueryParserFactory.QUERY_COMBINED_UNION_ALL); 
        }
        break;  
        ...
        case 305: 
        {
            ...
            setInt1(IBMiQueryParserFactory.QUERY_COMBINED_INTERSECT); 
        }
        break;  
        ...
        case 306: 
        {
            ...
            setInt1(IBMiQueryParserFactory.QUERY_COMBINED_INTERSECT_ALL); 
        }
        break;  
        ...
        case 307: 
        {
            ...
            setInt1(IBMiQueryParserFactory.QUERY_COMBINED_EXCEPT); 
        }
        break;  
        ...
        case 308: 
        {
            ...
            setInt1(IBMiQueryParserFactory.QUERY_COMBINED_EXCEPT_ALL); 
        }
        break;  
        ...
        /*
         *  Rule 312:  <query_stmt> ::= <query_exp_root> <opt_order_by_clause> <opt_updatability_clause>
         */
        case 312: 
        {
        ...
        /*
         *  Rule 315:  <query_term> ::= _LPAREN <query_exp> _RPAREN <opt_order_by_clause> <opt_fetch_first_clause>
         */
        case 315: 
        {
            if (checkStmtOnly) {
        ...
        /*
         *  Rule 316:  <query_values> ::= VALUES <values_row_commalist> <opt_order_by_clause> <opt_fetch_first_clause>
         */
        case 316: 
        {
            if (checkStmtOnly) {
        ...
        case 317: 
        {
            ...
            setInt1(IBMiQueryParserFactory.COMPARISON_OPERATOR_EQ); 
        }
        break;  
        ...
        case 318: 
        {
            ...
            setInt1(IBMiQueryParserFactory.COMPARISON_OPERATOR_LT); 
        }
        break;  
        ...
        case 319: 
        {
            ...
            setInt1(IBMiQueryParserFactory.COMPARISON_OPERATOR_LE); 
        }
        break;  
        ...
        case 320: 
        {
            ...
            setInt1(IBMiQueryParserFactory.COMPARISON_OPERATOR_NE); 
        }
        break;  
        ...
        case 321: 
        {
            ...
            setInt1(IBMiQueryParserFactory.COMPARISON_OPERATOR_GT); 
        }
        break;  
        ...
        case 322: 
        {
            ...
            setInt1(IBMiQueryParserFactory.COMPARISON_OPERATOR_GE); 
        }
        break;  
 
        /*
         *  Rule 325:  <row_comparison> ::= <value_expr_row> <relop> <value_expr_row>
         */
        case 325: 
        {
            if (checkStmtOnly) {
        ...
        case 342: 
        {
            ...
            setSym1(m_factory.createSpecialRegisterExpression(IBMiQueryParserFactory.SPECIAL_REGISTER_CURRENT_DATE)); 
        }
        break;  
        ...
        case 343: 
        {
            ...
            setSym1(m_factory.createSpecialRegisterExpression(IBMiQueryParserFactory.SPECIAL_REGISTER_CURRENT_TIME)); 
        }
        break;  
        ...
        case 344: 
        {
            ...
            setSym1(m_factory.createSpecialRegisterExpression(IBMiQueryParserFactory.SPECIAL_REGISTER_CURRENT_TIMESTAMP)); 
        }
        break;  
 
        /*
         *  Rule 345:  <special_register> ::= CURRENT_TIMESTAMP _LPAREN <timestamp precision> _RPAREN
         */
        case 345: 
        {
            if (checkStmtOnly) {
        ...
        case 346: 
        {
            ...
            setSym1(m_factory.createSpecialRegisterExpression(IBMiQueryParserFactory.SPECIAL_REGISTER_LOCALTIME)); 
        }
        break;  
 
        /*
         *  Rule 347:  <special_register> ::= LOCALTIME _LPAREN <time precision> _RPAREN
         */
        case 347: 
        {
            if (checkStmtOnly) {
        ...
        case 348: 
        {
            ...
            setSym1(m_factory.createSpecialRegisterExpression(IBMiQueryParserFactory.SPECIAL_REGISTER_LOCALTIMESTAMP)); 
        }
        break;  
 
        /*
         *  Rule 349:  <special_register> ::= LOCALTIMESTAMP _LPAREN <timestamp precision> _RPAREN
         */
        case 349: 
        {
            if (checkStmtOnly) {
        ...
        case 350: 
        {
            ...
            setSym1(m_factory.createSpecialRegisterExpression(IBMiQueryParserFactory.SPECIAL_REGISTER_CURRENT_DEFAULT_TRANSFORM_GROUP)); 
        }
        break;  
        ...
        /*
         *  Rule 353:  <special_register> ::= CURRENT_TRANSFORM_GROUP_FOR_TYPE <datatype_path-resolved_user-defined_type_name>
         */
        case 353: 
        {
            if (checkStmtOnly) {
            ...
            setSym1(m_factory.createSpecialRegisterExpression(IBMiQueryParserFactory.SPECIAL_REGISTER_CURRENT_TRANSFORM_GROUP_FOR_TYPE, (UserDefinedType) getSym(2))); 
        }
        break;  
        ...
        case 358: 
        {
            ...
            setSym1(m_factory.createSpecialRegisterExpression(IBMiQueryParserFactory.SPECIAL_REGISTER_VALUE)); 
        }
        break;  
        ...
        /*
         *  Rule 360:  <super_groups> ::= CUBE _LPAREN <super_groups_element_list> _RPAREN
         */
        case 360: 
        {
            if (checkStmtOnly) {
            ...
            setSym1( m_factory.createSuperGroups(getList(3), IBMiQueryParserFactory.SUPERGROUP_TYPE_CUBE) ); 
        }
        break;  
 
        /*
         *  Rule 361:  <super_groups> ::= ROLLUP _LPAREN <super_groups_element_list> _RPAREN
         */
        case 361: 
        {
            if (checkStmtOnly) {
            ...
            setSym1( m_factory.createSuperGroups(getList(3), IBMiQueryParserFactory.SUPERGROUP_TYPE_ROLLUP) ); 
        }
        break;  
        ...
        case 362: 
        {
            ...
            setSym1( m_factory.createSuperGroups(null, IBMiQueryParserFactory.SUPERGROUP_TYPE_GRANDTOTAL) ); 
        }
        break;  
        ...
        /*
         *  Rule 364:  <super_groups_element_exp_list> ::= <super_groups_element_exp>
         */
        case 364: 
        {
            if (checkStmtOnly) {
        ...
        /*
         *  Rule 365:  <super_groups_element_exp_list> ::= <super_groups_element_exp_list> _COMMA <super_groups_element_exp>
         */
        case 365: 
        {
            if (checkStmtOnly) {
        ...
        /*
         *  Rule 366:  <super_groups_element> ::= _LPAREN <super_groups_element_exp_list> _RPAREN
         */
        case 366: 
        {
            if (checkStmtOnly) {
        ...
        /*
         *  Rule 369:  <super_groups_element_list> ::= <super_groups_element_list> _COMMA <super_groups_element>
         */
        case 369: 
        {
            if (checkStmtOnly) {
        ...
        /*
         *  Rule 372:  <table_func> ::= TABLE _LPAREN <opt_schema_dot> <identifier> _LPAREN <opt_expression_commalist> _RPAREN _RPAREN <table_correlation>
         */
        case 372: 
        {
            if (checkStmtOnly) {
        ...
        /*
         *  Rule 373:  <table_join> ::= <table_ref> <opt_join_type> JOIN <table_ref> ON <condition>
         */
        case 373: 
        {
            if (checkStmtOnly) {
        ...
        /*
         *  Rule 375:  <table_qualified> ::= <schema> _DOT <table> <opt_table_correlation>
         */
        case 375: 
        {
            if (checkStmtOnly) {
        ...
        /*
         *  Rule 376:  <table_query> ::= _LPAREN <query_exp> _RPAREN <table_correlation>
         */
        case 376: 
        {
            if (checkStmtOnly) {
        ...
        /*
         *  Rule 377:  <table_query> ::= TABLE _LPAREN <query_exp> _RPAREN <table_correlation>
         */
        case 377: 
        {
            if (checkStmtOnly) {
        ...
        /*
         *  Rule 385:  <table_ref_commalist> ::= <table_ref_commalist> _COMMA <table_ref>
         */
        case 385: 
        {
            if (checkStmtOnly) {
        ...
        /*
         *  Rule 388:  <target_column_list> ::= <target_column_list> _COMMA <column_ref>
         */
        case 388: 
        {
            if (checkStmtOnly) {
        ...
        case 393: 
        {
            ...
            setSym1(m_factory.createUpdatabilityExpression(IBMiQueryParserFactory.UPDATABILITY_TYPE_FOR_READ_ONLY , null)); 
        }
        break;  
        ...
        case 394: 
        {
            ...
            setSym1(m_factory.createUpdatabilityExpression(IBMiQueryParserFactory.UPDATABILITY_TYPE_FOR_UPDATE , null)); 
        }
        break;  
 
        /*
         *  Rule 395:  <updatability_expression> ::= FOR UPDATE OF <column_name_list>
         */
        case 395: 
        {
            if (checkStmtOnly) {
            ...
            setSym1(m_factory.createUpdatabilityExpression(IBMiQueryParserFactory.UPDATABILITY_TYPE_FOR_UPDATE , getList(4))); 
        }
        break;  
 
        /*
         *  Rule 397:  <update_assignment_expression> ::= <column_ref> _EQ <expression>
         */
        case 397: 
        {
            if (checkStmtOnly) {
        ...
        /*
         *  Rule 398:  <update_assignment_expression> ::= _LPAREN <target_column_list> _RPAREN _EQ _LPAREN <query_exp> _RPAREN
         */
        case 398: 
        {
            if (checkStmtOnly) {
        ...
        /*
         *  Rule 399:  <update_assignment_expression> ::= _LPAREN <target_column_list> _RPAREN _EQ _LPAREN <expression_commalist> _RPAREN
         */
        case 399: 
        {
            if (checkStmtOnly) {
        ...
        /*
         *  Rule 400:  <update_assignment_expression_commalist> ::= <update_assignment_expression>
         */
        case 400: 
        {
            if (checkStmtOnly) {
        ...
        /*
         *  Rule 401:  <update_assignment_expression_commalist> ::= <update_assignment_expression_commalist> _COMMA <update_assignment_expression>
         */
        case 401: 
        {
            if (checkStmtOnly) {
        ...
        /*
         *  Rule 402:  <update_stmt> ::= UPDATE <target_table> <opt_as_target_table> SET <update_assignment_clause> <opt_where_clause>
         */
        case 402: 
        {
        ...
        /*
         *  Rule 403:  <value_expr_row> ::= _LPAREN <expression_commalist_multiple_elements> _RPAREN
         */
        case 403: 
        {
            if (checkStmtOnly) {
        ...
        /*
         *  Rule 407:  <values_row_commalist> ::= <values_row_commalist> _COMMA <values_row>
         */
        case 407: 
        {
            if (checkStmtOnly) {
        ...
        /*
         *  Rule 411:  <with_table_spec_list> ::= <with_table_spec_list> _COMMA <with_table_spec>
         */
        case 411: 
        {
            if (checkStmtOnly) {
        ...
        /*
         *  Rule 412:  <with_table_spec> ::= <table> <opt_column_name_list> AS _LPAREN <query_exp> _RPAREN
         */
        case 412: 
        {
            if (checkStmtOnly) {
        ...
        /*
         *  Rule 413:  <query_select> ::= SELECT <opt_all_distinct> <selection> <opt_into_clause> FROM <table_ref_commalist> <opt_where_clause> <opt_group_by_clause> <opt_having_clause> <opt_order_by_clause> <opt_fetch_first_clause> <opt_optimize_clause>
         */
        case 413: 
        {
            if (checkStmtOnly) {
            ...
            setSym1(m_factory.createQExtendedQuerySelect(getString(2),getList(3),getList(4),getList(6),(QuerySearchCondition)getSym(7),getList(8),(QuerySearchCondition)getSym(9), getList(10), getInt(11), getInt(12))); 
        }
        break;  
        ...
        /*
         *  Rule 423:  <optimize_clause> ::= OPTIMIZE FOR <opt_optimize_row_count> <row_or_rows>
         */
        case 423: 
        {
            if (checkStmtOnly) {
        ...
        /*
         *  Rule 426:  <table_qualified> ::= <schema> _DOT <table> <opt_table_correlation>
         */
        case 426: 
        {
            if (checkStmtOnly) {
        ...
        /*
         *  Rule 427:  <table_qualified> ::= <schema> _SLASH <table> <opt_table_correlation>
         */
        case 427: 
        {
            if (checkStmtOnly) {
