 ...
 * @generated
 */
public class DmlFactoryImpl extends EFactoryImpl implements QDmlFactory {
	/**
	 ...
	 * @generated
	 */
	public static QDmlFactory init() {
		try {
			QDmlFactory theDmlFactory = (QDmlFactory)EPackage.Registry.INSTANCE.getEFactory(QDmlPackage.eNS_URI);
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case QDmlPackage.EXTENDED_QUERY_SELECT: return createExtendedQuerySelect();
			case QDmlPackage.EXTENDED_QUERY_EXPRESSION_BODY: return createExtendedQueryExpressionBody();
			default:
	 ...
	 * @generated
	 */
	public QDmlPackage getDmlPackage() {
		return (QDmlPackage)getEPackage();
	}
	 ...
	 */
	@Deprecated
	public static QDmlPackage getPackage() {
		return QDmlPackage.eINSTANCE;
	}
