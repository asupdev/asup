 ...
 * <ul>
 *   <li>{@link org.asup.db.syntax.dbl.impl.FetchStatementImpl#getCursorName <em>Cursor Name</em>}</li>
 *   <li>{@link org.asup.db.syntax.dbl.impl.FetchStatementImpl#getInto <em>Into</em>}</li>
 *   <li>{@link org.asup.db.syntax.dbl.impl.FetchStatementImpl#getPosition <em>Position</em>}</li>
 *   <li>{@link org.asup.db.syntax.dbl.impl.FetchStatementImpl#getRelativePosition <em>Relative Position</em>}</li>
 *   <li>{@link org.asup.db.syntax.dbl.impl.FetchStatementImpl#getMultipleRowClause <em>Multiple Row Clause</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FetchStatementImpl extends BindingStatementImpl implements QFetchStatement {
	...
	protected EClass eStaticClass() {
		return QDblPackage.Literals.FETCH_STATEMENT;
	}
	...
	public void setCursorName(String newCursorName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QDblPackage.FETCH_STATEMENT__CURSOR_NAME, oldCursorName, cursorName));
	}
	...
	public void setInto(String newInto) {
		...
		into = newInto;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QDblPackage.FETCH_STATEMENT__INTO, oldInto, into));
	}
	...
	public void setPosition(FetchPosition newPosition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QDblPackage.FETCH_STATEMENT__POSITION, oldPosition, position));
	}
	...
	public void setRelativePosition(String newRelativePosition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QDblPackage.FETCH_STATEMENT__RELATIVE_POSITION, oldRelativePosition, relativePosition));
	}
	...
	public NotificationChain basicSetMultipleRowClause(QMultipleRowFetchClause newMultipleRowClause, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, QDblPackage.FETCH_STATEMENT__MULTIPLE_ROW_CLAUSE, oldMultipleRowClause, newMultipleRowClause);
	...
	public void setMultipleRowClause(QMultipleRowFetchClause newMultipleRowClause) {
		if (newMultipleRowClause != multipleRowClause) {
			...
			if (multipleRowClause != null)
				msgs = ((InternalEObject)multipleRowClause).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - QDblPackage.FETCH_STATEMENT__MULTIPLE_ROW_CLAUSE, null, msgs);
			if (newMultipleRowClause != null)
				msgs = ((InternalEObject)newMultipleRowClause).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - QDblPackage.FETCH_STATEMENT__MULTIPLE_ROW_CLAUSE, null, msgs);
			msgs = basicSetMultipleRowClause(newMultipleRowClause, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QDblPackage.FETCH_STATEMENT__MULTIPLE_ROW_CLAUSE, newMultipleRowClause, newMultipleRowClause));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case QDblPackage.FETCH_STATEMENT__MULTIPLE_ROW_CLAUSE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QDblPackage.FETCH_STATEMENT__CURSOR_NAME:
				return getCursorName();
			case QDblPackage.FETCH_STATEMENT__INTO:
				return getInto();
			case QDblPackage.FETCH_STATEMENT__POSITION:
				return getPosition();
			case QDblPackage.FETCH_STATEMENT__RELATIVE_POSITION:
