 ...
 * <ul>
 *   <li>{@link org.asup.db.syntax.ddl.QRollbackStatement#isHold <em>Hold</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.asup.db.syntax.ddl.QDdlPackage#getRollbackStatement()
 * @model
 * @generated
 */
public interface QRollbackStatement extends QDefinitionStatement {
	 ...
	 * @see #setHold(boolean)
	 * @see org.asup.db.syntax.ddl.QDdlPackage#getRollbackStatement_Hold()
	 * @model
	 * @generated
	 */
	boolean isHold();
	...
	/**
	 * Sets the value of the '{@link org.asup.db.syntax.ddl.QRollbackStatement#isHold <em>Hold</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
