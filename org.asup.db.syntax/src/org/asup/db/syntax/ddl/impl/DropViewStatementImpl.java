 ...
 * <ul>
 *   <li>{@link org.asup.db.syntax.ddl.impl.DropViewStatementImpl#getViewName <em>View Name</em>}</li>
 *   <li>{@link org.asup.db.syntax.ddl.impl.DropViewStatementImpl#getRange <em>Range</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class DropViewStatementImpl extends EObjectImpl implements QDropViewStatement {
	/**
	 * The cached value of the '{@link #getViewName() <em>View Name</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getViewName()
	 * @generated
	...
	protected EClass eStaticClass() {
		return QDdlPackage.Literals.DROP_VIEW_STATEMENT;
	}
	...
	public QQualifiedName getViewName() {
		if (viewName != null && ((EObject)viewName).eIsProxy()) {
			...
			viewName = (QQualifiedName)eResolveProxy(oldViewName);
			if (viewName != oldViewName) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, QDdlPackage.DROP_VIEW_STATEMENT__VIEW_NAME, oldViewName, viewName));
			}
		}
		return viewName;
	}
	 ...
	 * @generated
	 */
	public QQualifiedName basicGetViewName() {
		return viewName;
	}
	...
	public void setViewName(QQualifiedName newViewName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QDdlPackage.DROP_VIEW_STATEMENT__VIEW_NAME, oldViewName, viewName));
	}
	...
	public void setRange(DropRange newRange) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QDdlPackage.DROP_VIEW_STATEMENT__RANGE, oldRange, range));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QDdlPackage.DROP_VIEW_STATEMENT__VIEW_NAME:
				if (resolve) return getViewName();
				return basicGetViewName();
			case QDdlPackage.DROP_VIEW_STATEMENT__RANGE:
				return getRange();
		}
