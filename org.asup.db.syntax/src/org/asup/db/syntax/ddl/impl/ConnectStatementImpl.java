 ...
 *   <li>{@link org.asup.db.syntax.ddl.impl.ConnectStatementImpl#getUser <em>User</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConnectStatementImpl extends EObjectImpl implements QConnectStatement {
	...
	protected EClass eStaticClass() {
		return QDdlPackage.Literals.CONNECT_STATEMENT;
	}
	...
	public void setPwd(String newPwd) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QDdlPackage.CONNECT_STATEMENT__PWD, oldPwd, pwd));
	}
	...
	public void setReset(boolean newReset) {
		...
		reset = newReset;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QDdlPackage.CONNECT_STATEMENT__RESET, oldReset, reset));
	}
	...
	public void setTo(String newTo) {
		...
		to = newTo;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QDdlPackage.CONNECT_STATEMENT__TO, oldTo, to));
	}
	...
	public void setUser(String newUser) {
		...
		user = newUser;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QDdlPackage.CONNECT_STATEMENT__USER, oldUser, user));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case QDdlPackage.CONNECT_STATEMENT__RESET:
				return isReset();
			case QDdlPackage.CONNECT_STATEMENT__TO:
				return getTo();
			case QDdlPackage.CONNECT_STATEMENT__USER:
				return getUser();
		}
