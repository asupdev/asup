 ...
 * <ul>
 *   <li>{@link org.asup.db.syntax.ddl.impl.DropIndexStatementImpl#getIndexName <em>Index Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class DropIndexStatementImpl extends EObjectImpl implements QDropIndexStatement {
	/**
	...
	protected EClass eStaticClass() {
		return QDdlPackage.Literals.DROP_INDEX_STATEMENT;
	}
		...
		if (indexName != null && ((EObject)indexName).eIsProxy()) {
			...
			if (indexName != oldIndexName) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, QDdlPackage.DROP_INDEX_STATEMENT__INDEX_NAME, oldIndexName, indexName));
			}
		}
		return indexName;
	}
	...
	public void setIndexName(QQualifiedName newIndexName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QDdlPackage.DROP_INDEX_STATEMENT__INDEX_NAME, oldIndexName, indexName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QDdlPackage.DROP_INDEX_STATEMENT__INDEX_NAME:
