 ...
 * <ul>
 *   <li>{@link org.asup.db.syntax.ddl.impl.ReleaseStatementImpl#getType <em>Type</em>}</li>
 ...
 * @generated
 */
public class ReleaseStatementImpl extends EObjectImpl implements QReleaseStatement {
	/**
	...
	public void setType(StatementType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QDdlPackage.RELEASE_STATEMENT__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QDdlPackage.RELEASE_STATEMENT__TYPE:
				return getType();
